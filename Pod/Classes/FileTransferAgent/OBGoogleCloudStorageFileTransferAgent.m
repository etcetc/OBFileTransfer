...
#else
    [request setValue:[NSString stringWithFormat:@"multipart/related;boundary=%@", OBGSFTAHttpFormBoundary ] forHTTPHeaderField:@"Content-Type"];
...
#endif
    return [NSString stringWithFormat:@"%@/upload/storage/v1/b/%@/o?%@key=%@",kBaseCloudUrl, urlComponents[@"bucketName"],uploadType, self.apiKey];
}
